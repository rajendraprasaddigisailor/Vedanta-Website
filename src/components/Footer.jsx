  ...
  <div className="foot-inner">
    ...
    <div className="foot-manifesto">
      ...
      <div className="cta-card reveal delay-2">
        ...
        <div className="btns">
          <a href="#" className="primary">Contact us <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M13 5l7 7-7 7"/></svg></a>
    ...
    <div className="foot-grid">
      <div className="foot-col foot-brand reveal">
        ...
        <div className="socials">
          ...
          <a href="#" aria-label="Instagram"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/></svg></a>
