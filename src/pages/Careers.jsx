...
<section className="page-section">
  <div className="ps-inner">
    ...
    <div className="jobs-list">
      <a className="job reveal" href="#"><div className="j-title">Senior Metallurgist — Smelter</div><div className="j-meta"><span>Thoothukudi, TN</span><span>Full-time</span><span>7–12 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Electrical Engineer — Acid Plant</div><div className="j-meta"><span>Thoothukudi, TN</span><span>Full-time</span><span>4–8 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Environmental Compliance Lead</div><div className="j-meta"><span>Thoothukudi, TN</span><span>Full-time</span><span>8–14 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Process Engineer — Rod Plant</div><div className="j-meta"><span>Silvassa, DNH</span><span>Full-time</span><span>3–6 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Community Relations Officer</div><div className="j-meta"><span>Thoothukudi, TN</span><span>Full-time</span><span>5–10 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Manager — Sustainability Reporting</div><div className="j-meta"><span>Mumbai, MH</span><span>Full-time</span><span>6–10 yrs</span></div><div className="j-arrow">→</div></a>
      <a className="job reveal" href="#"><div className="j-title">Graduate Engineer Trainee (2026 batch)</div><div className="j-meta"><span>Thoothukudi · Silvassa</span><span>Full-time</span><span>Fresher</span></div><div className="j-arrow">→</div></a>
    </div>
  </div>
</section>
