...
<section className="page-section" style={{"paddingTop":"clamp(40px, 5vw, 60px)"}}>
  <div className="ps-inner">
    <div className="news-feature">
      <div className="nf-img" style={{"backgroundImage":"url('assets/hero.png')"}}></div>
      <div className="nf-body">
        ...
        <a className="btn-ghost reveal delay-4" href="#">Read the release →</a>
      </div>
    </div>
...
<section className="cta-band">
  <div className="cta-inner">
    ...
    <div className="cta-btns"><a href="mailto:media@sterlitecopper.com" className="btn-primary">Email the press desk →</a><a href="contact.html" className="btn-primary btn-sm">General contact</a></div>
  </div>
</section>
