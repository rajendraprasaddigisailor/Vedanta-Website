...
<section className="products reveal" aria-label="Products" style={{"paddingTop":"clamp(40px, 5vw, 60px)"}}>
  <div className="products-grid reveal delay-3">
    <div className="product-card"><div className="swatch-cu"></div><div className="spec">LME Grade A</div><h3>Copper Cathodes</h3><p className="reveal">99.99% Cu electrolytically refined cathodes — feedstock for cables, transformers, EV motors and renewables.</p><div className="product-meta"><div>Purity<strong>99.99% Cu</strong></div><div>Registered<strong>LME &amp; COMEX</strong></div></div><div className="actions"><a className="btn-buy reveal delay-4" href="buy.html">Buy now →</a></div></div>
    <div className="product-card rod"><div className="swatch-cu"></div><div className="spec">8 mm CCR</div><h3>Continuous Cast Rods</h3><p className="reveal">Oxygen-free 8&nbsp;mm copper rods drawn directly from cathode — zero-defect feed for wire and cable mills.</p><div className="product-meta"><div>Diameter<strong>8 mm standard</strong></div><div>Capacity<strong>216,000 MTPA</strong></div></div><div className="actions"><a className="btn-buy reveal delay-4" href="buy.html">Buy now →</a></div></div>
    <div className="product-card acid"><div className="swatch-cu"></div><div className="spec">98% H₂SO₄</div><h3>Sulphuric Acid</h3><p className="reveal">Captured from smelter off-gas — used in fertilisers, batteries, textiles and pharma across western India.</p><div className="product-meta"><div>Concentration<strong>98% by mass</strong></div><div>Capacity<strong>1.2 M MTPA</strong></div></div><div className="actions"><a className="btn-buy reveal delay-4" href="contact.html">Enquire →</a></div></div>
    <div className="product-card phos"><div className="swatch-cu"></div><div className="spec">Fertiliser grade</div><h3>Phosphoric Acid</h3><p className="reveal">Merchant-grade phosphoric acid for DAP, MAP and NPK fertiliser producers — a key input for Indian agriculture.</p><div className="product-meta"><div>Grade<strong>Fertiliser</strong></div><div>Capacity<strong>220,000 MTPA</strong></div></div><div className="actions"><a className="btn-buy reveal delay-4" href="contact.html">Enquire →</a></div></div>
    <div className="product-card slag"><div className="swatch-cu"></div><div className="spec">Secondary use</div><h3>Granulated Slag</h3><p className="reveal">Smelter slag processed into construction-grade aggregate and sand-blasting media — circular-economy by-product.</p><div className="product-meta"><div>Application<strong>Cement, blasting</strong></div><div>Utilisation<strong>~100% diverted</strong></div></div><div className="actions"><a className="btn-buy reveal delay-4" href="contact.html">Enquire →</a></div></div>
  </div>
</section>
...
<section className="cta-band">
  <div className="cta-inner">
    ...
    <div className="cta-btns"><a href="buy.html" className="btn-primary">Buy now →</a><a href="contact.html" className="btn-primary btn-sm">Talk to sales</a></div>
  </div>
</section>
