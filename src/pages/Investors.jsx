...
<section className="fin-tiles reveal" style={{"paddingTop":"clamp(40px, 5vw, 60px)"}}>
  <div className="fin-inner">
    ...
    <div className="fin-grid reveal delay-3">
      <div className="fin-tile reveal"><div className="kpi-lab">Revenue</div><div className="kpi-val">₹24,830 Cr</div><div className="kpi-delta up">▲ 12.4% YoY</div><div className="kpi-caption">Consolidated FY24</div></div>
      <div className="fin-tile reveal"><div className="kpi-lab">EBITDA</div><div className="kpi-val">₹3,190 Cr</div><div className="kpi-delta up">▲ 8.7% YoY</div><div className="kpi-caption">Margin 12.8%</div></div>
      <div className="fin-tile reveal"><div className="kpi-lab">Cathode production</div><div className="kpi-val">364 KT</div><div className="kpi-delta up">▲ 4.1% YoY</div><div className="kpi-caption">91% utilisation</div></div>
      <div className="fin-tile reveal"><div className="kpi-lab">Net debt / EBITDA</div><div className="kpi-val">0.6×</div><div className="kpi-delta down">▼ 0.2 from FY23</div><div className="kpi-caption">Investment-grade</div></div>
    </div>
